...
function monthKeyInTokyo(d: Date): string {
 ...
 */
export function isLastThursdayOfMonthInTokyo(now: Date): boolean {
...
export function isLastDayOfMonthInTokyo(now: Date): boolean {
...
/** 東京の現在時刻（0–23） */
export function getHourInTokyo(now: Date): number {
